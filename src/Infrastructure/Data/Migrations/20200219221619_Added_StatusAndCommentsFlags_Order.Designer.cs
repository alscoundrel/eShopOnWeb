...
namespace Microsoft.eShopWeb.Infrastructure.Data.Migrations
{
    ...
    [Migration("20200219221619_Added_StatusAndCommentsFlags_Order")]
    partial class Added_StatusAndCommentsFlags_Order
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.StoreAggregate.Store", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.StoreAggregate.StoreItem", b =>
                {
                    ...
                    b.HasKey("StoreId", "CatalogItemId");

                    b.ToTable("StoresItems");
                });

            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.WishListAggregate.WishItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("NotifyCasePriceChanges")
                        .HasColumnType("bit");

                    b.Property<int>("NotifyChoice")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTimeOffset>("WishDate")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.WishListAggregate.WishList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.eShopWeb.ApplicationCore.Entities.WishListAggregate.WishItem", b =>
                {
                    b.HasOne("Microsoft.eShopWeb.ApplicationCore.Entities.WishListAggregate.WishList", null)
                        .WithMany("Items")
